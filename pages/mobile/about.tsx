...
export default function About() {
    return (
        <Layout>
            <div style={{ padding: "0 10px", color: "#000", fontFamily: "Audiowide" }}>
                ...
                <br />
                <br />
                <span style={{ fontSize: "30px", fontFamily: "Alegreya Sans", fontWeight: "bold" }}>
                TOY DAPP
                </span>
                <br />
                <br />
                ...
                <br />
                <br />
                <span style={{ fontSize: "30px", fontFamily: "Alegreya Sans", fontWeight: "bold" }}>MISSION</span>
                <br />
                <br />
