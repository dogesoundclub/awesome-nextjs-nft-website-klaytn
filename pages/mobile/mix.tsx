    ...
    return (
        <Layout>
            <div style={{ padding: "0 10px", color: "#000", fontFamily: "Sunflower" }}>
                <img src="/mobile/mix/banner.webp" alt="" style={{ width: "100%", marginBottom: "20px" }} />
                ...
                <div style={{ fontSize: "19px", marginBottom: "15px" }}>
                    To find more information &gt;&gt;&gt; <a href="https://github.com/dogesoundclub" target="_blank" style={{ color: "#00f" }}>Github</a>
                </div>
                <div style={{ color: "#36B167", textDecoration: "underline", fontSize: "25px", marginBottom: "15px" }}>
                    Governance
                </div>
                <div style={{ fontSize: "19px", marginBottom: "15px" }}>
                    We use our own Governance tool(bot) &gt;&gt;&gt; <a href="https://snapshot.org/" target="_blank" style={{ color: "#00f" }}>Snapshot.org</a>
                </div>
                <div style={{ color: "#36B167", textDecoration: "underline", fontSize: "25px", marginBottom: "15px" }}>MIX MARKETPLACE</div>
                <img src="/mobile/mix/footer.webp" alt="" style={{ width: "100%" }} />
            </div>
        </Layout>
    );
}
